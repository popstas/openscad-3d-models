...
sections_w = is_small ? [10, 20, 30] : [30, 68, 99.5];
...
inner_y      = is_small ? 20 : 160; // номинальная длина по Y
inner_h      = is_small ? 10 : (31 + 2); // внутренняя высота во всех отсеках (максимум)
