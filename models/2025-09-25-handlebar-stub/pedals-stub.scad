...
cap_d_outer   = 28.2;   // внешний диаметр шапки, мм
cap_h         = 0.1; //4.2;    // высота шапки над плоскостью, мм
cap_shell_th  = 1.0;    // толщина оболочки купола, мм

// 2) Вставка с лепестками (конус + прорези)
insert_d_bottom = 25;   // диаметр у основания (вход в трубу), мм
insert_d_top    = 23;   // диаметр у верхней кромки, мм
