...
cap_d_outer   = 23;   // внешний диаметр шапки, мм
cap_h         = 2.7; //4.2;    // высота шапки над плоскостью, мм
cap_shell_th  = 1.0;    // толщина оболочки купола, мм

// 2) Вставка с лепестками (конус + прорези)
insert_d_bottom = 18.8;   // диаметр у основания (вход в трубу), мм
insert_d_top    = 16.8;   // диаметр у верхней кромки, мм
insert_h        = 14.0;   // общая высота вставки, мм
petal_ch        = 2.0;    // высота нижней фаски лепестков, мм
petals_n        = 6;      // количество лепестков
