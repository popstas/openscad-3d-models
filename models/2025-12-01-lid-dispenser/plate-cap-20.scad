...
cap_inner_d     = 19.6; // 76 - стакан, маленькая банка, 78.2 - кофейная кружка, 87 - чайная кружка, 125.1 - блюдце // внутренний диаметр колпака (посадка)
wall_th         = 1.0;     // толщина стенки (радиальная)
top_th          = 1.6;     // толщина крышки сверху
cap_height      = 8;       // общая наружная высота колпака
fit_extra_inner = 0.15;    // технологический запас внутрь (увеличение внутреннего Ø)
test_cut_d      = 5;      // диаметр вырезки в середине cap_inner_d - 
