...
// -------------------------------------------------
// Геометрия
P1_D = 70;     // нижний внешний диаметр основания (мм)
P1_H = 6;      // высота основания (мм)
P2_H = 40;     // высота усечённого конуса (мм)
P3_D = 20;     // внешний диаметр горлышка (мм)
P3_H = 15;     // высота горлышка (мм)

wall_th = 2.0; // толщина стенок воронки (мм)
