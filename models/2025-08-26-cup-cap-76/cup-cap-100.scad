...
cap_inner_d     = 100; // 76 - стакан, маленькая банка, 78.2 - кофейная кружка, 87 - чайная кружка, 125.1 - блюдце // внутренний диаметр колпака (посадка)
wall_th         = 1.0;     // толщина стенки (радиальная)
top_th          = 1.6;     // толщина крышки сверху
cap_height      = 10;     // общая наружная высота колпака
